...
abstract class CalendarPagerView extends ViewGroup
    ...
    private Map<DayOfWeek, Drawable> dayOfWeekDrawableIconBottom;
    ...
    protected void addDayView(Collection<DayView> dayViews, LocalDate temp) {
        ...
        dayView.setIconBottomDrawable(null);
        dayViews.add(dayView);
        addView(dayView, new LayoutParams());
    }

    protected void addDayView(Collection<DayView> dayViews, LocalDate temp, Drawable iconBottomDrawable) {
        CalendarDay day = CalendarDay.from(temp);
        DayView dayView = new DayView(getContext(), day);
        dayView.setOnClickListener(this);
        dayView.setOnLongClickListener(this);
        dayView.setIconBottomDrawable(iconBottomDrawable);
        dayViews.add(dayView);
        addView(dayView, new LayoutParams());
    }
    ...
    public Map<DayOfWeek, Drawable> getDayOfWeekDrawableIconBottom() {
        return dayOfWeekDrawableIconBottom;
    }
