...
public class WeekPagerAdapter extends CalendarPagerAdapter<WeekView> {
    ...
    public WeekPagerAdapter(MaterialCalendarView mcv, Map<DayOfWeek, Drawable> dayOfWeekDrawableIconBottom) {
        super(mcv, dayOfWeekDrawableIconBottom);
    }

    @Override
    protected WeekView createView(int position) {
        return new WeekView(mcv, getItem(position), mcv.getFirstDayOfWeek(), showWeekDays, getDayOfWeekDrawableIconBottom());
    }
