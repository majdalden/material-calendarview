...
public class MaterialCalendarView extends ViewGroup {
    ...
    private Map<DayOfWeek, Drawable> dayOfWeekDrawableIconBottom = new HashMap<>();
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        if (isInEditMode()) {
            removeView(pager);
            MonthView monthView = new MonthView(this, currentMonth, getFirstDayOfWeek(), true, dayOfWeekDrawableIconBottom);
...
//    final int desiredHeight = 0;
    ...
    private void commit(State state) {
        ...
        switch (calendarMode) {
            case MONTHS:
                newAdapter = new MonthPagerAdapter(this, dayOfWeekDrawableIconBottom);
                break;
            case WEEKS:
                newAdapter = new WeekPagerAdapter(this, dayOfWeekDrawableIconBottom);
                break;
            default:
